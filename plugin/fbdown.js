          ...
          message: {
            ...
            interactiveMessage: proto.Message.InteractiveMessage.create({
              body: proto.Message.InteractiveMessage.Body.create({
                text: ` Facebook Video Download\n\n🔍 Select the desired video quality to download.\n\n📌 Choose an option to download.\n\n`
              }),
              footer: proto.Message.InteractiveMessage.Footer.create({
                text: "> ©ʀᴇᴅ-ꜰᴏx-ᴍᴅ"
              }),
              header: proto.Message.InteractiveMessage.Header.create({
                 ...(await prepareWAMessageMedia({ image: { url: `https://i.ibb.co/tmBwc3w/Picsart-24-06-24-07-49-44-807.png` } }, { upload: Matrix.waUploadToServer })),
                title: "",
                gifPlayback: true,
                subtitle: "",
    ...
    if (selectedId.startsWith('media_')) {
      ...
      if (selectedMedia) {
        try {
          ...
          if (fileSizeInMB <= 300) {
            content = { video: finalMediaBuffer, mimetype: 'video/mp4', caption: '> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʀᴇᴅ_ꜰᴏx-ᴍᴅ ' };
