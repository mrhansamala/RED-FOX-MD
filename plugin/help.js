...
header: proto.Message.InteractiveMessage.Header.create({
    ...(await prepareWAMessageMedia({ image : fs.readFileSync('../../media/red-menu.png')}, { upload: Matrix.waUploadToServer})), 
      title: `🦊ʀᴇᴅ-ꜰᴏx🦊`,
      gifPlayback: true,
      subtitle: " ᴍᴇɴᴜ",
        ...
        "rows":[
          {
           "header":"",
           "title":"🔰 ᴀʟʟ ᴍᴇɴᴜ",
           "description":"> 💈⃟🦊ᴀʟʟ ᴍᴇɴᴜ ",
           "id":"View All Menu"
          },
          {
            "header":"",
            "title":"⬇️ ᴅᴏᴡɴʟᴀᴏᴅᴇʀ ᴍᴇɴᴜ",
            "description":"> 💈⃟🦊ꜱʜᴏᴡ ᴀʟʟ ᴅᴏᴡɴʟᴏᴀᴅ ꜰᴇᴀᴛᴜᴛᴇꜱ ",
            "id":"Downloader Menu"
          },
          {
            "header":"",
            "title":"👨‍👨‍👧‍👧ɢʀᴏᴜᴘ ᴍᴇɴᴜ",
            "description":"> 💈⃟🦊ꜰᴇᴀᴛᴜᴛᴇꜱ ᴛʜᴇᴛ ᴀʀᴇ ᴏɴʟʏ ᴀᴠɪʟᴀʙʟᴇ ꜰᴏʀ ɢʀᴏᴜᴘ ",
            "id":"Group Menu"
          },
          {
            "header":"",
            "title":"👨‍🔧 ᴛᴏᴏʟ ᴍᴇɴᴜ",
            "description":"> 💈⃟🦊ꜱʜᴏᴡ ᴍᴇ ᴛᴏᴏʟ ᴍᴇɴᴜ ",
            "id":"Tool Menu"
          },
          {
            "header":"",
            "title":"🗿 ᴍᴀɪɴ ᴍᴇɴᴜ",
            "description":"> 💈⃟🦊ʙᴏᴛ ᴍᴀɪɴ ᴄᴏᴍᴍᴀɴᴅꜱ ",
            "id":"Main Menu"
          },
         {
            "header":"",
            "title":"👨‍💻 ᴏᴡɴᴇʀ ᴍᴇɴᴜ",
            "description":"> 💈⃟🦊ꜰᴇᴀᴛᴜᴛᴇꜱ ᴛʜᴀᴛ ᴀʀᴇ ᴏɴʟʏ ꜰᴏʀ ᴍʏ ʜᴀɴᴅꜱᴏᴍᴇ ᴏᴡɴᴇʀ ",
            "id":"Owner Menu"
          },
          {
            "header":"",
            "title":"✨ ᴀɪ ᴍᴇɴᴜ",
            "description":"> 💈⃟🦊ꜱʜᴏᴡ ᴍᴇ ᴀɪ ᴍᴇɴᴜ ",
            "id":"Ai Menu"
          },
          {
            "header":"",
            "title":"🔍sᴇᴀʀᴄʜ ᴍᴇɴᴜ🔎",
            "description":"> 💈⃟🦊ꜱʜᴏᴡ ᴍᴇ ꜱᴇᴀʀᴄʜ ᴍᴇɴᴜ ",
            "id":"Search Menu"
          },
          {
            "header":"",
            "title":"🧚‍♂️ sᴛᴀʟᴋ ᴍᴇɴᴜ",
            "description":"> 💈⃟🦊ꜱʜᴏᴡ ᴍᴇ ꜱᴛᴀʟᴋ ᴍᴇɴᴜ ",
            "id":"Stalk Menu"
          },
          {
            "header":"",
            "title":"🥏 ᴄᴏᴠᴇʀᴛᴇʀ ᴍᴇɴᴜ",
            "description":"> 💈⃟🦊ꜱʜᴏᴡ ᴍᴇ ᴄᴏᴠᴇʀᴛᴇʀ ᴍᴇɴᴜ ",
            "id":"Converter Menu"
          }
        ]}
      ]}`
